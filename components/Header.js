...
const Header = () => {
  ...
  return (
    <div className='sticky top0 z-50 flex items-center p-2 lg:px-5 shadow-md'>
      ...
      <div className='flex items-center sm:space-x-2 justify-end'>
        ...
        <p className='font-semibold pr-3 whitespace-nowrap text-gray-500'>{session.user.name}</p>
